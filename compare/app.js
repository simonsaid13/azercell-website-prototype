 ...
 * INBOUND: nav-lab Compare tariffs; personal prepaid/postpaid Compare; homepage Compare — CONNECTED
 * OUTBOUND: View tariff → official Azercell URLs — CONNECTED (external)
 * Tab URLs: ?billing=prepaid|postpaid; Header EN/AZ/RU selects Compact / Detailed / RU layout
 */
(function () {
  'use strict';
